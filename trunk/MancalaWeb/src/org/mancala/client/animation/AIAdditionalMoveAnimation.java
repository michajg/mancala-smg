 ...
 */
public class AIAdditionalMoveAnimation extends Animation {
	...
	public AIAdditionalMoveAnimation(Element element, Graphics graphics) {
	...
	protected void onComplete() {
		...
		graphics.afterAIAdditionalMoveAnimation();
	}
