...
public class State { 
	...
	/*
	 * A Mancala board consists out of 14 pits - 7 for the north player and 7 for the south player. 
	 * Every player has 6 "normal" pits and one treasure chest.
	 * The pits are mirrored to each other - the pits array indexes can be laid out like this
	 * north: 6 5 4 3 2 1 0 
	 * south:   0 1 2 3 4 5 6
	 * where index 6 is the treasure chest of that player.
	 */
	 ...
	 * <p>Every time one side is completely dealt you continue with the other side
	 * <p>Only the players own treasure chest receives seeds in the process
	 * <p>If last seed is placed in a treasure chest, the player moves again 
	 * <p>If last seed is placed in an empty pit, this seed and the opposing seeds all go into the players treasure chest
	 * <p>If all pits are empty on at least on side the game ends
	 * 
	 * @param chosenPitIndex the index corresponding with the user selected pit 
	 */
	...
	/**
	 * True if the last seed was placed on a treasure chest. 
	 * Since only the treasure chest of the use whose turn it is receiving seeds this means the user gets another turn
	 * 
	 * @param indexLastSeedPlaced index where the last seed was placed
	 ...
	 * 
	 * @param activePits the pits (north or south) where the seeds are being placed
	...
	/**
	 * If last seed was placed on an empty pit and it was not the treasure chest
	 * check if the opposing pit is not empty
	 * If that's the case both the last seed and the seeds in the opposing pit 
	 * are removed from their pits and added to the treasure chest 
	 * 
	 * @param indexLastSeedPlaced index where the last seed was placed
	 * @param activePits the pits (north or south) where the last seed was placed
	 */
	 ...
	 * 
	 * @param pits the pits array where all seeds should be in the treasure chest
	 */
	 ...
	 * the game ends if all of the pits of at least one side is empty 
	 * 
	...
	/**
	 * The pits are mirrored to each other the pits arrays are basically like this
	 * 6 5 4 3 2 1 0 
	 *   0 1 2 3 4 5 6
	 * where index 6 is the treasure chest. 
	 * This method returns the index of the opposing pit given an index 
	 * 
	 * @param index the pit to which you want the opposing pit index to
	 * @param maxIndex the length of the pits array
	...
	/**
	 * Returns leading player (SOUTH or NORTH). If it's a tie E is getting returned.
	 * A player leads if he has more seeds in his treasure chest than the other
	 * 
